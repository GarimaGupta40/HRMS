...
export class MemStorage implements IStorage {
  ...
  async createPaymentRecord(paymentRecord: InsertPaymentRecord): Promise<PaymentRecord> {
    ...
    const newPaymentRecord: PaymentRecord = {
      ...
      daysWorked: paymentRecord.daysWorked ?? null,
      totalDaysInMonth: paymentRecord.totalDaysInMonth ?? null,
      grossSalary: paymentRecord.grossSalary ?? null,
      basicSalary: paymentRecord.basicSalary ?? null,
      hra: paymentRecord.hra ?? null,
      da: paymentRecord.da ?? null,
      specialAllowance: paymentRecord.specialAllowance ?? null,
      conveyance: paymentRecord.conveyance ?? null,
      medical: paymentRecord.medical ?? null,
      otherAllowance: paymentRecord.otherAllowance ?? null,
      bonus: paymentRecord.bonus ?? null,
      overtime: paymentRecord.overtime ?? null,
      epf: paymentRecord.epf ?? null,
      esic: paymentRecord.esic ?? null,
      professionalTax: paymentRecord.professionalTax ?? null,
      tds: paymentRecord.tds ?? null,
      mlwf: paymentRecord.mlwf ?? null,
      otherDeductions: paymentRecord.otherDeductions ?? null,
      totalDeductions: paymentRecord.totalDeductions ?? null,
    };
